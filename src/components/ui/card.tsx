  ...
  "rounded-2xl text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        elevated: "bg-card border border-border/30 shadow-card hover:shadow-glow",
        spiritual: "bg-primary text-primary-foreground border border-primary/10 shadow-card",
